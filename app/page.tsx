  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 pb-16">
        <div className="bg-blue-50 rounded-2xl border border-blue-200 p-8 md:p-10 text-center">
          <Briefcase className="h-12 w-12 text-blue-600 mx-auto mb-4" />
          <h2 className="text-2xl font-semibold text-slate-900 mb-3">Looking to Hire?</h2>
