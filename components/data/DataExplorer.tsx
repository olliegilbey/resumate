        ...
        children: company.children
          .map((position) => ({
            ...
            children: position.children.filter((bullet) => {
              ...
              const matchesTags =
                selectedTags.length === 0 || selectedTags.some((tag) => bullet.tags.includes(tag));
              ...
              <div className="text-slate-400 mb-4">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 2C6.477 2 2 6.477 2 12s4.477 10 10 10c1.563 0 3.049-.358 4.373-.989L19 19l-3-3zM13 7a4 4 0 11-8 0 4 4 0 018 0z"
                  />
                </svg>
              </div>
