...
const STEPS: StepConfig[] = [
  { id: "verifying", label: "Verify identity", activeLabel: "Verifying identity..." },
  {
    ...
    activeLabel: "Analyzing job description...",
  },
  {
    id: "selecting",
    label: "Select relevant experience",
    activeLabel: "Selecting relevant experience...",
  },
...
function StepIcon({
  ...
  if (isRetrying) {
    return <RefreshCw className="h-4 w-4 text-amber-500 dark:text-amber-400 animate-spin" />;
  }
          ...
          <div className="mt-4 pt-3 border-t border-red-200 dark:border-red-800">
            <div className="flex items-start gap-2 text-red-600 dark:text-red-400">
              ...
              <div className="font-mono text-sm">
                ...
                <p className="text-xs mt-1 text-red-500 dark:text-red-400/80">{error}</p>
              </div>
            </div>
          </div>
        )}
