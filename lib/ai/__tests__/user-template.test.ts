      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              description: "Mentored 5 junior engineers, establishing code review practices",
              priority: 7,
          ...
          children: [
            {
              ...
              description: "Optimized database queries reducing latency by 60%",
              priority: 8,
...
describe("buildUserPrompt", () => {
  ...
  it("includes retry context when provided", () => {
    const prompt = buildUserPrompt(sampleJobDescription, mockCompendium, {
      maxBullets: 3,
      retryContext: "error[E004_WRONG_BULLET_COUNT]: Expected 3 bullets, got 2",
    });
