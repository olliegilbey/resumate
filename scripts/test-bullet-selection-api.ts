...
async function testBulletSelection(roleProfileId: string) {
  console.log(`\n🎯 Testing bullet selection for role: ${roleProfileId}\n`);
  ...
  try {
    ...
    console.log(`✅ Success! Selected ${data.count} bullets\n`);
    ...
    console.log("⚙️  Selection Config:");
    ...
    console.log("📋 Top 10 Selected Bullets:\n");
    ...
    for (const item of data.selected) {
      ...
      positionCounts[item.positionId] = (positionCounts[item.positionId] || 0) + 1;
    }

    console.log("📈 Diversity Statistics:");
    console.log(`   Companies represented: ${Object.keys(companyCounts).length}`);
    console.log(`   Positions represented: ${Object.keys(positionCounts).length}`);
    console.log(
