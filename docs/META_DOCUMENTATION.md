...
| **`docs/TODOS.md`** | Tasks | Daily | Active tasks | Completed >7 days |
...
✅ **Delete old completed tasks (>7 days)**
- Keeps TODOS.md clean
...
### `scripts/archive-todos.sh`
**Trigger:** Pre-commit (markdown changes)
**Action:** Delete completed tasks >7 days from TODOS.md
...
### Before Work
1. Check `.claude/CLAUDE.md` → Find docs
2. Read `docs/CURRENT_PHASE.md` → Current phase
3. Read `docs/TODOS.md` → Active tasks
4. Read component CLAUDE.md if in subdirectory
...
### After Work
1. Update `docs/TODOS.md` (mark complete, add date)
...
- [TODOS.md](./TODOS.md) - Active tasks
